...
public class FlashBang extends CustomBomb {
    public FlashBang(Player thrower, Item bomb) {
        ...
        final BombValues bombValues = BombConfigurations.getInstance().getBombValues().get(BombType.FLASH_BANG);
    ...
    public void affectPlayer(Player player) {
        player.setMetadata(BombType.FLASH_BANG.name(), new FixedMetadataValue(nl.rubixstudios.bombplugin.Bomb.getInstance(), true));
    ...
    public void removeEffect(Player player) {
        player.removeMetadata(BombType.FLASH_BANG.name(), nl.rubixstudios.bombplugin.Bomb.getInstance());
    ...
    public boolean isAffected(Player player) {
        return player.hasMetadata(BombType.FLASH_BANG.name());
    }
